package com.kavrin.paging3.screens.common
		...
		modifier = Modifier
			.clickable {
				val browserIntent = Intent(
					Intent.ACTION_VIEW,
					Uri.parse("${unsplashImage.user.userLinks.html}?utm_source=Paging3Demo&utm_medium=referral")
				)
				startActivity(
					context,
					browserIntent,
